            ...
            <div className='detail-page-container'>
                <div className='book-detail-container'>
                    ...
                    <div className='d-flex flex-column gap-3'>
                        ...
                        <div className='little-detail-container'>
                            {book.isbn && (
                                <div className='little-detail link'><i className="fa-solid fa-barcode"></i> <a href={`https://openlibrary.org/isbn/${book.isbn}`} target="_blank" rel="noreferrer">{book.isbn}</a></div>
                            )}
                            {book.olid && (
                                <div className='little-detail link'><i className="fa-solid fa-barcode"></i> <a href={`https://openlibrary.org/books/${book.olid}`} target="_blank" rel="noreferrer">{book.olid}</a></div>
                            )}
                        </div>
